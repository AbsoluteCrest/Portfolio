    ...
    return (
        <main className="flex flex-col gap-8 row-start-2 sm:items-start">
            ...
            <div className="my-20 space-y-20">
                ...
                <div className="my-20  rounded-lg p-9 bg-neutral-900 font-roboto font-bold text-4xl w-3/5 animate-fade-up ">
                    <header className="font-roboto text-5xl mb-4">Absolute Crest</header>
                    <p className="font-roboto text-base">Cześć, nazywam się Piotr. 👋<br/>
                ...
                <div className="flex flex-col justify-center h-full font-roboto font-bold text-4xl animate-fade-up-delay">
                    <div className="flex flex-wrap gap-5 justify-center items-center ">
                        <div className="rounded-lg p-9 bg-neutral-900 text-left w-full md:flex-[1_0_30%]  text-base">
                            <header className="font-roboto text-5xl font-bold mb-6">Tech Stacks</header>
                            ...
                            <div className="flex justify-between items-center gap-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Typescript</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Javascript</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">HTML</h2>
                                        <h3 className="text-sm text-neutral-500">Średniozaawansowany</h3>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">CSS</h2>
                                        <h3 className="text-sm text-neutral-500">Średniozaawansowany</h3>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Tailwind</h2>
                                        <h3 className="text-sm text-neutral-500">Początkujący</h3>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Next.js</h2>
                                        <h3 className="text-sm text-neutral-500">Początkujący</h3>
                                    </div>
                                </div>
                ...
                <div
                    className="flex flex-col justify-center h-full font-roboto font-bold text-4xl animate-fade-up-more-delay ">
                    <div className="flex flex-wrap gap-5 justify-center items-center ">
                        <div className="rounded-lg p-9 bg-neutral-900 text-left w-full md:flex-[1_0_30%] text-base">
                            <header className="font-roboto text-5xl font-bold mb-6">Narzędzia</header>
                            ...
                            <div className="flex justify-between items-center gap-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Webstorm</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Node</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Git</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto">Figma</h2>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left2 text-nowrap">
                                        <h2 className="font-roboto  ">NPM</h2>
